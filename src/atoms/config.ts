...
export const ConfigAtom = atom<Config>((()=>{
  try{
    ...
    const defaultValue: Config = { audio: { deviceId: "default" }, profiles: {default: {id: crypto.randomUUID(), key: "default", name: "default", keywords: []}}, profileAutoSwitch: true, startWords: [], stopWords: [], remote:{send:"127.0.0.1:9000",listen: "127.0.0.1:9001"} }
    return defaultValue;
  }
})())
